...
#region Public Fields
    ...
    public Player  player;     // TODO: Implement as a prefab generated by the gamemanager.
    public string  nextLevel;  // Intentionally blank - MUST be set on a per-level basis.
    public string  level       = D_LEVEL;
    public float   gravity     = D_GRAVITY;
